...
<img src="/assets/public/img/tt/v/macos/1.png" width="500px">
<img src="/assets/public/img/tt/v/macos/2.png" width="500px">
<img src="/assets/public/img/tt/v/macos/3.png" width="500px">
<img src="/assets/public/img/tt/v/macos/4.png" width="500px">
<p>2）运行V2RayX软件<img src="/assets/public/img/tt/v/macos/9.png" width="50px">，然后在任务栏打开软件主菜单，将V节点信息配置到软件，最后启动代理，过程如下图所示：</p>
...
<img src="/assets/public/img/tt/v/macos/8.png" width="700px">
<h2>三、使用</h2>
...
<h2>四、常见问题</h2>
<p>使用软件后，有时候重启电脑开机不能正常打开网页？手动取消代理设置即可：Mac在系统偏好设置—网络—高级—代理，取消勾选。</p>
</div>
</body>
</html>